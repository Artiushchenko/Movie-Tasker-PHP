...
if($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $connection->prepare("
        INSERT INTO tasks (title, description, category, is_completed, is_editing, time, user_email)
        VALUES (?, ?, ?, ?, ?, ?, ?);
    ");
    $stmt->bind_param("sssiiis", $taskTitle, $taskDescription, $taskCategory, $is_completed, $is_editing, $time, $user_email);
